...
![image-20240812233549185](cuda编程入门.assets/image-20240812233549185.png)
...
![image-20240812235145858](cuda编程入门.assets/image-20240812235145858.png)

### 2、线程模型与物理结构

![image-20240813000037115](cuda编程入门.assets/image-20240813000037115.png)

补充：1个wrap就是一个线程束

### 3、线程束

![image-20240813000837413](cuda编程入门.assets/image-20240813000837413.png)
...
​			时间局部性原理：如果一个数据在一段时间被访问，那么在不久的将来，这个数据会被访问。

​			空间局部性原理：如果一个地址被访问，那么地址附近的内存空间都可能会被访问。

### 2、CUDA内存模型

![image-20240813002152230](cuda编程入门.assets/image-20240813002152230.png)
...
![image-20240813003446022](cuda编程入门.assets/image-20240813003446022.png)

### 2、本地内存

![image-20240813003647738](cuda编程入门.assets/image-20240813003647738.png)

![image-20240813004146032](cuda编程入门.assets/image-20240813004146032.png)

大于则表示寄存器溢出。

### 3、寄存器溢出

![image-20240813004438738](cuda编程入门.assets/image-20240813004438738.png)
...
![image-20240813124516110](cuda编程入门.assets/image-20240813124516110.png)



### 2、全局内存初始化

![image-20240813124652196](cuda编程入门.assets/image-20240813124652196.png)

## 五、共享内存

### 1、共享内存作用

![image-20240813130542324](cuda编程入门.assets/image-20240813130542324.png)

## 六、常量内存

### 1、常量内存作用

![image-20240813132036534](cuda编程入门.assets/image-20240813132036534.png)
...
![image-20240813135215336](cuda编程入门.assets/image-20240813135215336.png)

补充：如果要避免线程束分化，所以一个线程束中的所有线程在统一周期中必须执行相同的指令。

![image-20240813135945759](cuda编程入门.assets/image-20240813135945759.png)



### 2、并行规约计算

![image-20240813140456117](cuda编程入门.assets/image-20240813140456117.png)



![image-20240813141109649](cuda编程入门.assets/image-20240813141109649.png)

将这八个线程块返回到主机，然后进行串行计算。

![image-20240813141700476](cuda编程入门.assets/image-20240813141700476.png)
